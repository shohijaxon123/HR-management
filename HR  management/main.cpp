	...
	do
	{
		...
		case 7:
			if (admin.is_List_of_candidates_empty()==1) {
				...
				cout << "Enter experience required: "; cin >> exp;
				cout << "Enter minimal rating required: "; cin>> number;
...
int print_menu() {
	...
	cout << "3 - " << "Show new Candidates." << endl;
	cout << "4 - " << "Show Accepted Candidates." << endl;
	cout << "5 - " << "Show new Employees." << endl;
	...
	cout << "14 - Delete all the data from a file." << endl;
	cout << "---------------------------------\n" << endl;
...
vector<string> set_requirements() {
	...
	while (skill != "stop") {
		requirements.push_back(toLowerCase(skill));
		cout << "Enter: "; cin >> skill;
	}
...
void Prelimenary_data() {
	...
	vector<string> requirements3 = { "Rust", "html", "python", "JAVA", "Css", "Git"}; //6 skills
